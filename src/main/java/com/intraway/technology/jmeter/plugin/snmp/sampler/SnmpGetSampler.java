...
public class SnmpGetSampler extends AbstractSnmpSampler {
  private static final long serialVersionUID = 6393722552275749483L;
  private static final Logger logger = LoggerFactory.getLogger(SnmpGetSampler.class);
  ...
  public SampleResult sample(Entry arg0) {
    ...
    String msg = "SNMP Get - snmpVersion [" + snmpVersion + "] - host[" + host + "] - port [" + port + "] - community [" + community + "] - oid [" + oid
    ...
    try {
      result = client.call(CommandName.GET, version, new String[] { oid }, community, InetAddress.getByName(host), port, timeout, retries, null, null, null);
