...
public class SnmpException extends Exception {
  ...
  /**
   * Represents a <CODE>Walk</CODE> request. A walk uses the
   * <CODE>getNext</CODE> request to "walk" through a given MIB.
   */
  ...
  /**
   * Code as defined in RFC 1157 for generic trap info in Trap-PDU:
   * <CODE>egpNeighborLoss</CODE>.
   */
  public static final int trapEgpNeighborLoss = 5;

  /**
   * Code as defined in RFC 1157 for generic trap info in Trap-PDU:
   * <CODE>enterpriseSpecific</CODE>.
   */
   ...
   * <P>
   * Used if the request PDU exceeds the <CODE>maxTries</CODE> limit defined in
   ...
   * Error code specific to the API.
   * <P>
   * Used if the request PDU does not fit in the <CODE>maxSnmpPktSize</CODE>
   ...
   * Error code specific to the API.
   * <P>
   * Used for the last variable returned by a <CODE>Walk</CODE> request PDU.
   */
   ...
   * Error code specific to the API.
   * <P>
   * Used if the request PDU is retried after a <CODE>noSuchName</CODE> error
   ...
   * Error code specific to the API.
   * <P>
   * Used if the size of the request PDU <CODE>varBindList</CODE> exceeds the
   * <CODE>maxVarBindLimit</CODE> limit defined in the
   ...
   * Error code specific to the API.
   * <P>
   * Used if the request PDU fails with a <CODE>tooBig</CODE> error status but
   * its <CODE>varBindList</CODE> contains just one element.
   */
  ...
  /**
   * Constructs a new <CODE>SnmpException</CODE> with the specified status
   * error.
   * 
   * @param status
   *          The error status.
