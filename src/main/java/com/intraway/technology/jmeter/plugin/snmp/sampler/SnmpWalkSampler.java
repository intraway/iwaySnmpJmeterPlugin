...
public class SnmpWalkSampler extends AbstractSnmpSampler {
  ...
  public SampleResult sample(Entry arg0) {
    ...
    String msg = "SNMP Walk - snmpVersion [" + snmpVersion + "] - host[" + host + "] - port [" + port + "] - community [" + community + "] - oid [" + oid
    ...
    try {
      result = client.call(CommandName.WALK, version, new String[] { oid }, community, InetAddress.getByName(host), port, timeout, retries, null, null, null);
